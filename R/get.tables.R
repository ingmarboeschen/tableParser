#' get.tables
#'
#' Extracts HTML tables as vector of tables from plain HTML code, HTML, HML, XML or CERMXML files.
#' @param x HTML, HML, XML or CERMXML file or character object with HTML-encoded content.
#' @return Character vector with one plain HTML-encoded table per cell.
#' @export
